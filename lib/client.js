 ...
 * @type {function}
 */
JSZhuyinClient.prototype.onchunkload = null;
/**
 * Run when each of the file (a "chunk" of the storage) is inserted
 * into IndexedDB.
 * @type {function}
 */
JSZhuyinClient.prototype.onpopulated = null;
/**
 * Run once when the initial chunk of data is available.
 * @type {function}
 */
JSZhuyinClient.prototype.onpartlyloaded = null;
/**
 ...
 * @this   {object}   JSZhuyin instance.
 */
JSZhuyinClient.prototype.uninstall = function jzc_uninstall() {
  if (!this.loaded)
    throw 'Already unloaded.';
