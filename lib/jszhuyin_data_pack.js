 ...
 * @type {String}
 */
JSZhuyinDataPack.prototype.SEPARATOR = ',';
/**
...
JSZhuyinDataPack.prototype.getFirstResult = function() {
  ...
  var stop = this.packed.indexOf(this.SEPARATOR, 4);
  if (stop === -1)
...
JSZhuyinDataPack.prototype.unpack = function() {
  ...
  this.packed
    .substr(Float32Encoder.STRING_LENGTH)
    .split(this.SEPARATOR).forEach(function(str, i) {
      if (!i)
        return;
...
JSZhuyinDataPack.prototype.pack = function() {
  ...
  this.unpacked.forEach(function(result, i) {
    var str = '';
    if (i === 0)
      str += Float32Encoder.encode(result['score']);
