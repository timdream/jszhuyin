 ...
 * @this   {object}   JSZhuyinIME instance.
 */
JSZhuyinIME.prototype.handleAction = function ji_handleAction(type, data) {
  if (!this.queue)
...
JSZhuyinIME.prototype.query = function ji_query() {
  ...
  if (count === 0) {
    ...
    this.returnResult(encodedStr, compositions);
