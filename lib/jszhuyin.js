...
JSZhuyin.prototype.query = function jz_query(reqId) {
      ...
      var composedResultData = composition
        ...
        .reduce(function(composedResultData, symbolCodesResultData) {
          ...
          if (!symbolCodesResultData[0]) { // No dataPack returned
            ...
            composedResultData[0] += BopomofoEncoder.decode(
              String.fromCharCode.apply(String, symbolCodesResultData[1]));
  ...
  while (i--) {
    ...
    symbolLength = BopomofoEncoder.decode(
      String.fromCharCode.apply(String, arr)).length;
  ...
  if (BopomofoEncoder.isCompleted(expendedEncodedSounds[0]) &&
    ...
    var str = BopomofoEncoder.decode(
      String.fromCharCode(expendedEncodedSounds[0]));
