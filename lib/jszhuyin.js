...
JSZhuyin.prototype.query = function jz_query(reqId) {
  ...
  // |compositions| would contains all possible compositions & combinations
  // of the current symbols string. Depend on the length of symbols we would
  // choose different way to construct it.
  var compositions =
