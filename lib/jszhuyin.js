...
JSZhuyin.prototype.query = function jz_query(reqId) {
  ...
  // LONGEST_PHRASE_LENGTH; if so it's not possible to compose the entire
  // symbol string with only one symbol string!
  var trimmedSymbolsCombinations, trimmedSymbols;
