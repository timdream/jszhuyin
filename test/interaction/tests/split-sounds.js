...
(function(factory) {
  ...
  TaskTest.NAME = 'Type ㄊㄞˊㄅㄟˇㄕㄨ, split sounds';
  TaskTest.prototype = {
    tasks: [
      {
        fn: 'handleKey',
        ...
        checkCallbackValues: function(values) {
          assert.strictEqual(values.compositionupdate, 'ㄊㄞˊㄅㄟˇㄕㄨ');
          assert.deepEqual(values.candidateschange,
            [['台北市ㄨ', this.candidateId++],
             ['台北市', this.candidateId++],
             ['臺北市', this.candidateId++],
             ['台北', this.candidateId++],
